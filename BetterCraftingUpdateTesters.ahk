...
if (seedCraftActionQueue.Length() > 0) {
	...
	seedCraftingLocked := 1
	SetTimer, UnlockSeedCraft, 0 ; -1200000 
	...
	seedCraftingLocked := 1
	SetTimer, UnlockSeedCraft, 0 ; -600000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        seedCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
	...
	seedCraftingLocked := 1
	SetTimer, UnlockSeedCraft, 0 ; -960000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        seedCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
	...
	seedCraftingLocked := 1
	SetTimer, UnlockSeedCraft, 0 ; -1500000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        seedCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
	...
	seedCraftingLocked := 1
	SetTimer, UnlockSeedCraft, 0 ; -900000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        seedCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
	...
	seedCraftingLocked := 1
	SetTimer, UnlockSeedCraft, 0 ; -1800000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        seedCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
	...
	seedCraftingLocked := 1
	SetTimer, UnlockSeedCraft, 0 ; -2700000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        seedCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
...
if (bearCraftActionQueue.Length() > 0) {
	...
	bearCraftingLocked := 1
	SetTimer, UnlockBearCraft, 0 ; -3600000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
	...
	bearCraftingLocked := 1
	SetTimer, UnlockBearCraft, 0 ; -900000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        bearCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
	...
	bearCraftingLocked := 1
	SetTimer, UnlockBearCraft, 0 ; -300000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        bearCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
	...
	bearCraftingLocked := 1
	SetTimer, UnlockBearCraft, 0 ; -1800000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        bearCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
	...
	bearCraftingLocked := 1
	SetTimer, UnlockBearCraft, 0 ;  -7200000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        bearCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
	...
	bearCraftingLocked := 1
	SetTimer, UnlockBearCraft, 0 ; -14400000
	SendDiscordMessage(webhookURL, "Attempted to craft " . currentItem . ".")
        bearCraftActionQueue.RemoveAt(1)
        Sleep, 50
    }
