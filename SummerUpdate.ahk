...
Gui, Add, Edit, x369 y132 w36 h18 vManualBearCraftLock gUpdateCraftLock -Theme cBlack, %ManualBearCraftLock%
    ...
    Gui, Add, Text, x414 y285 w84  h20 gHarvestButton         BackgroundTrans 0x4
    ...
    Gui, Add, Picture, x0 y-5 w520 h425 BackgroundTrans, % mainDir "rbx macro setting  tab Harvest button.PNG" 
