...
Loop, % seedItems.Length() {
    ...
    Gui, Add, Text, x30 y120 center BackgroundTrans c87CEEB, Summer
    Gui, Add, Text, x+5 center BackgroundTrans cWhite, and
    Gui, Add, Text, x+5 center BackgroundTrans cFF7518, Harvest
    Gui, Font, s9 cWhite Bold, Segoe UI
    IniRead, SelectAllSummer, %settingsFile%, Summer, SelectAll, 0
    Gui, Add, CheckBox, % "x48 y191 w13 h13 vSelectAllSummer gHandleSelectAll BackgroundTrans cFFD700 " . (SelectAllSummer ? "Checked" : "")
    Gui, Add, Text, x+5 BackgroundTrans cC6CED1 ,Select All                 Summer Shop
    ...
    Loop, % summerItems.Length() {
        ...
        Gui, Add, Text, x+5 BackgroundTrans cC6CED1 , % SummerItems[A_Index]
    }

    ; Buttons
    Gui, Add, Button, x560 y320 w120 h40 gToggleRecording  Background202020, Record New Path `n(F1)
    Gui, Add, Button, x560 y+10 w120 h40 gDemoInput  Background202020, Test Path `n(F2)
    Gui, Add, Button, x560 y+10 w120 h40 gLoadInputs  Background202020, Load Saved Path `n(F3)
    Gui, Add, Button, x560 y+10 w120 h40 gF4  Background202020, Test Auto-Harvest `n(F4)

    ; Auto-collect checkbox
    IniRead, autoSummerHarvest, %settingsFile%, Main, SummerHarvest, 0
    Gui, Add, Checkbox, x560 y220 w13 h13 vautoSummerHarvest cFF7518, Auto-Collect & Submit Summer Harvest
    Gui, Font, s9 cWhite Bold, Segoe UI
    Gui, Add, Text, x+5 BackgroundTrans  cFF7518 , Auto Harvest and submit
    ...
    Gui, Add, Edit, x560 y240 w25 h18 vnumberOfCycle +BackgroundFFFFFF, %savedNumberOfCycle%

    Gui, Font, s9 cWhite Bold, Segoe UI
    Gui, Add, Text, x+5 BackgroundTrans cFF7518 , Number of Cycle

    Gui, Font, s8 cD3D3D3 Bold, Segoe UI
    Gui, Add, Button, x600 y290  h18 gUpdateNumberOfCycle  Background202020, Save settings

    ; Collect method

    Gui, Font, s8 cBlack, Segoe UI
    IniRead, savedHarvestSpeed, %settingsFile%, Main, HarvestSpeed, Stable
    Gui, Add, DropDownList, vsavedHarvestSpeed gUpdateHarvestSpeed x560 y260 w35, Stable|Fast
    GuiControl, ChooseString, savedHarvestSpeed, %savedHarvestSpeed%
    Gui, Font, s9 cWhite Bold, Segoe UI
    Gui, Add, Text, x+5 BackgroundTrans cFF7518 , Collect Method

    Gui, Font, s12 cBlack, Segoe UI
    Gui, Add, Text, x310 y192 w200 BackgroundTrans center cYellow , Automated summer harvest and submit
    Gui, Font, s9 cBlack, Segoe UI
    Gui, Add, Text, y+20 w200 BackgroundTrans cwhite ,
    ( 
...
Once it's all done, you can now start the macro and the Summer Harvest is now automated.
     ...
     Gui, Font, s8 cBlack, Segoe UI
     Gui, Add, Text, x655 y550 w120 BackgroundTrans cwhite ,
     (
       -CREDIT-nasayuzaki- 
     )
    ...
    Gui, Add, Text, X569 y266 W209  h55 BackgroundTrans  center cC6CED1 0X4,pets

    Gui, Add, Text, X569 y310 W209  h55 BackgroundTrans gGui5  center  cC6CED1 0X4,
    Gui, Add, Text, X569 y325 W209  h55 BackgroundTrans   center  cC6CED1 0X4,Eggs
    ...
    Gui, Add, Text, x40 y125  BackgroundTrans cC6CED1 ,Webdhook URL :
    ...
    Gui, Add, Text, x+5 w105 h16 BackgroundTrans gDisplayServerValidity center cC6CED1 ,Save Priavte Server
